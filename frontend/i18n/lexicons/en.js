export default {
  ...
  models: {
    ...
    payment: {
      ...
      remote_data: 'Payment status on the service',
      filter: {
        all: 'All Payments',
        paid: 'Paid',
        error: 'Error',
    ...
    subscription: {
      title_one: 'Subscription',
      title_many: 'Subscriptions',
      id: 'Id',
      service: 'Service',
      active: 'Activated',
      cancelled: 'Do Not Prolong',
      active_until: 'Active Until',
      created_at: 'Created At',
      warned_at: 'The date of the warning about the next charge',
      level: 'Current Level',
  ...
  components: {
    ...
    payment: {
      ...
      subscription: {
        ...
        month_1: 'Payment every 30 days, next charge {date}.',
        month_3: 'Payment every 90 days, next charge {date}.',
        month_6: 'Payment every 180 days, next charge {date}.',
        month_12: 'Payment every 360 days, next charge {date}.',
